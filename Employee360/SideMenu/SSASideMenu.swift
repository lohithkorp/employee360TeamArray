...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    struct ContentViewEffect {
        ...
        var alpha: Float = 1.0
        var scale: Float = 0.7
        var landscapeOffsetX: Float = 75
        var portraitOffsetX: Float = 75
        ...
        init(alpha: Float = 1.0, scale: Float = 0.7, landscapeOffsetX: Float = 75, portraitOffsetX: Float = 75, minParallaxContentRelativeValue: Float = -25.0, maxParallaxContentRelativeValue: Float = 25.0, interactivePopGestureRecognizerEnabled: Bool = true) {
    ...
    @IBInspectable var type: SSASideMenuType = .slip
